...
registerLocale('en', {
    brand: {
        ...
        spaceP1: 'For me, foresight is not daydreaming on paper. A scenario earns its keep when it can be implemented for the tomorrow of real systems, not only for the next meeting slide.',
        spaceP2: 'FORESIGHT HUB is my personal lab, where FITness, Futures Wheel, CLA, and backcasting meet lived experience building intelligent systems and scalable infrastructure.',
        pathTag: 'Path',
        pathTitle: 'How my path took shape',
        pathP1: 'I started in electrical engineering, widened that lens through an MBA in human resources toward organizations, and now in a Futures Studies PhD I am joining those loops.',
        collabTag: 'Collaborate',
        collabTitle: 'How we can work together',
        collabP1: 'I am available for university teaching, organizational workshops, joint projects, and advisory work in strategic foresight and emerging infrastructure.',
        collabP2: '',
        contactTag: 'Contact',
        contactTitle: 'Get in touch',
        contactP1: 'For teaching, a workshop, or a short conversation, email me.',
        ...
        philP3: 'Design is intentionally readable and minimal; hierarchy matters more than visual effects.',
        focusTitle: 'Focus',
        focuses: [],
        ctaResume: 'CV',
    ...
    aboutPage: {
        ...
        researchFocus: [
            ...
            'Emerging technologies and innovation systems',
            'Type-2 fuzzy logic and deep uncertainty',
            'Weak signals and trend detection',
