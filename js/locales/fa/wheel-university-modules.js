...
registerLocale('fa', {
    ...
    industry: {
            tag: 'کارگاه Futures Wheel',
            title: 'پیامدهای زنجیره‌ای برای تصمیم محصول و ریسک',
            intro: 'کارگاه سازمانی برای کشیدن پیامدهای مرتبه ۱ تا ۳ یک تغییر فناوری یا مقرراتی قبل از سرمایه‌گذاری بزرگ.',
            meta: [
                {
                    label: 'مدت',
                    value: '۳ تا ۴ ساعت'
                ...
                {
                    label: 'خروجی',
                    value: 'چرخ پیامد + فرصت/تهدید'
                },
                {
                    label: 'مخاطب',
                    value: 'محصول، ریسک، استراتژی، عملیات'
                }
            ],
            agenda: [
                {
                    block: '۳۰ دقیقه',
                    title: 'انتخاب driver',
                    desc: 'یک تغییر مرکزی واضح.'
                },
                {
                    block: '۶۰ دقیقه',
                    title: 'مراتب ۱ و ۲',
                    desc: 'پیامدهای مستقیم و ثانویه با STEEP.'
                },
                {
                    block: '۴۵ دقیقه',
                    title: 'مرتبه ۳ و حلقه‌ها',
                    desc: 'پیامدهای دوردست و بازخورد.'
                },
                {
                    block: '۴۵ دقیقه',
                    title: 'اولویت اقدام',
                    desc: 'سه فرصت و سه تهدید برای ۹۰ روز.'
                }
            ],
            stakeholders: [
                {
                    role: 'محصول',
                    job: 'تعریف driver و فرض رشد'
                },
                {
                    role: 'ریسک',
                    job: 'تهدیدهای مرتبه ۲ و ۳'
                },
                {
                    role: 'عملیات',
                    job: 'شدنی‌بودن پیامد'
                ...
                {
                    role: 'استراتژی',
                    job: 'اولویت سرمایه‌گذاری'
                }
            ],
            deliverables: [
                'چرخ کامل مرتبه ۱ تا ۳',
                'برچسب STEEP',
                'لیست فرصت/تهدید',
                'سه اقدام ۹۰ روزه'
            ],
            workflow: [
                {
                    title: 'مرکز',
                    desc: 'driver را قفل کنید.'
                },
                {
                    title: 'cascade',
                    desc: 'مراتب را بدون mind-map شل بکشید.'
                },
                {
                    title: 'برچسب',
                    desc: 'STEEP و احتمال/شدت سبک.'
                },
                {
                    title: 'اقدام',
            ...
            checklist: [
                'driver یک جمله است',
                'مراتب از هم جدا شده‌اند',
                'حداقل یک حلقه بازخورد دیده شده',
                'اقدام‌ها مالک دارند',
                'به سناریو قابل اتصال است'
            ],
            boardMemo: [
                'driver',
                'سه پیامد حیاتی',
            ...
            facilitator: [
                'از انشعاب بی‌انتها جلوگیری کنید',
                'مراتب را رنگی جدا کنید',
                'ذهن‌نگاشت را از Wheel تفکیک کنید',
                'خروجی را به تصمیم فصل وصل کنید'
            ]
        }
    }
});
