                    ...
                    lectureSections: [
                        {
                            ...
                            paragraphs: [
                                'تصور کنید مدیرعامل در پایان سال وارد اتاق می‌شود. روی میز، پنج جلد گزارش ضخیم است: سناریو، روند فناوری، ریسک‌های ژئوپolitik، پیشنهاد مشاور، و یک PowerPoint ۱۲۰ اسلایدی. همه applaud می‌کنند. سه ماه بعد، رقیب با یک pilot کوچک بازار را عوض می‌کند. هیچ‌کس نمی‌گوید «ما foresight نداشتیم» — همه می‌گوینند «گزارش داشتیم».',
