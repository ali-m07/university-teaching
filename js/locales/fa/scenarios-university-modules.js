...
registerLocale('fa', {
    advancedPage: {
        scenarios: {
            ...
            industrySectionTitle: 'مسیر صنعت · استقرار در سازمان',
                ...
                modules: [
                    ...
                    {
                        num: 'M4', id: 'm4', pickerLabel: 'گونه‌شناسی سناریو',
                        title: 'گونه‌شناسی سناریو: گوده، بزولد و بل', hours: '۹۰ دقیقه',
                        readingsShort: 'Godet · Bell · Bezold',
                        visual: 'assets/methods/covers/scenarios-m4-typologies.svg',
                        visualCaption: 'اکتشافی/هنجاری × کیفی/کمی/مشارکتی',
                        lectureIntro: 'جلسه چهارم نشان می‌دهد سناریو یک روش نیست، خانواده‌ای از روش‌هاست. گونه‌شناسی گوده، مشارکت بزولد و طبقه‌بندی وندل بل کمک می‌کند روش درست برای هر پرسش انتخاب شود.',
                        lectureSections: [
                            {
                                id: 'need-typology',
                                title: '۱. چرا یک گونه‌شناسی لازم است',
                                slideTitles: [
                                    'سناریوی Shell با سناریوی سیاستی یکسان نیست',
                                    'دو محور اصلی گونه‌شناسی',
                                    'خطر انتخاب نادرست روش'
                                ],
                                paragraphs: [
                                    'سناریوی Shell برای آمادگی ذهنی مدیران ساخته شد؛ سناریوی مشارکتی یک شهرداری برای ساخت توافق میان شهروندان طراحی می‌شود. هر دو «سناریو» نام دارند اما منطق ساخت متفاوتی دارند.',
                                    'دو محور رایج برای دسته‌بندی سناریوها وجود دارد: اکتشافی در برابر هنجاری، و کیفی در برابر کمی. این دو محور به‌تنهایی چهار خانواده اصلی سناریو می‌سازند.',
                                    'انتخاب نادرست گونه هزینه واقعی دارد: اجرای یک فرآیند کمی سنگین برای پرسشی که فقط به گفتگوی مشارکتی نیاز داشت، وقت و اعتبار سازمان را هدر می‌دهد.'
                                ]
                            },
                            {
                                id: 'godet-types',
                                title: '۲. اکتشافی و هنجاری نزد گوده',
                                slideTitles: [
                                    'سناریوی اکتشافی: از امروز به جلو',
                                    'سناریوی هنجاری: از آینده مطلوب به عقب',
                                    'روش کمی SMIC و cross-impact'
                                ],
                                paragraphs: [
                                    'میشل گوده سناریوی اکتشافی را حرکت از روندها و عدم‌قطعیت‌های امروز به سوی چند آینده ممکن تعریف می‌کند؛ منطقی نزدیک به سناریوی Shell و Schwartz.',
                                    'سناریوی هنجاری برعکس حرکت می‌کند: نقطه شروع یک آینده مطلوب است و پرسش این است که چه مسیرهایی به آن می‌رسند؛ همان منطقی که در backcasting دیده‌اید.',
                                    'گوده و دوپرن در سال ۱۹۷۵ روش SMIC را برای گروه‌بندی احتمالی سناریوها بر پایه cross-impact میان فرض‌ها پیشنهاد دادند؛ نسخه کمی‌تر از ماتریس ۲×۲ کیفی رایج در کلاس‌های مدیریت.'
                                ]
                            },
                            {
                                id: 'bezold-bell',
                                title: '۳. مشارکت بزولد و طبقه‌بندی وندل بل',
                                slideTitles: [
                                    'کلمنت بزولد و سناریوی مشارکتی',
                                    'ممکن، محتمل، مطلوب نزد وندل بل',
                                    'انتخاب گونه برای پروژه شما'
                                ],
                                paragraphs: [
                                    'کلمنت بزولد سناریوسازی مشارکتی را برای فرآیندهای سیاستی و سلامت عمومی توسعه داد؛ جایی که ساخت توافق میان ذی‌نفعان مهم‌تر از دقت تحلیلی صرف است.',
                                    'وندل بل در مبانی مطالعات آینده، آینده‌های ممکن، محتمل و مطلوب را از هم جدا می‌کند. این سه‌گانه پرسش دقیق‌تری می‌سازد: آیا این سناریو ممکن است، محتمل است، یا ما آن را مطلوب می‌دانیم؟',
                                    'برای انتخاب گونه، ابتدا تصمیم محوری M1 و مخاطب پروژه را بازبینی کنید: تصمیم راهبردی سطح بالا معمولا اکتشافی و کیفی می‌خواهد، سیاست عمومی مشارکتی، و مدل‌سازی ریسک مالی معمولا کمی.'
                                ]
                            }
                        ],
                        readings: [
                            ...
                            { type: 'مقاله کلاسیک', text: 'Duperrin, J.C. & Godet, M. (1975). SMIC 74: a method for constructing and ranking scenarios.' },
                            { type: 'کتاب', text: 'Bell, W. (1997). <em>Foundations of Futures Studies</em>, جلد ۱ و ۲.' },
                            { type: 'یادداشت درسی', text: 'خلاصه فارسی جلد دوم وندل بل و خلاصه آینده‌نگاری استراتژیک عیوضی، به‌عنوان یادداشت تدریس برای این جلسه.' }
                        ],
                        assignment: {
                            title: 'انتخاب گونه سناریو',
                            description: 'برای پروژه ترم خود گونه سناریو را انتخاب و توجیه کنید.',
                            body: [
                                'مشخص کنید پروژه شما اکتشافی یا هنجاری است و چرا.',
                                'مشخص کنید به روش کیفی، کمی یا مشارکتی نیاز دارید و یک دلیل عملی بنویسید.'
                            ],
                            format: 'نیم صفحه',
                            criteria: ['تطابق گونه با پرسش پروژه', 'استدلال روشن به‌جای انتخاب پیش‌فرض']
                        }
                    }
                ]
            },
        industry: {
                tag: 'کارگاه سناریو',
                title: 'سناریوهای تصمیم‌محور برای استراتژی فصلی',
                intro: 'کارگاه برای کمیته استراتژی: عدم‌قطعیت‌های حیاتی، ماتریس ۲×۲، نشانه‌های زودهنگام و گزینه‌های no-regret.',
                meta: [
                    {
                        label: 'مدت',
                        value: 'یک روز یا دو نیم‌روز'
                    },
                    {
                        label: 'خروجی',
                        value: 'چهار سناریو + indicators'
                    },
                    {
                        label: 'مخاطب',
                        value: 'هیئت‌مدیره سبک، استراتژی، مالی، محصول'
                    }
                ],
                agenda: [
                    {
                        block: '۶۰ دقیقه',
                        title: 'پرسش تصمیم',
                        desc: 'چه تصمیمی باید زیر عدم‌قطعیت گرفته شود؟'
                    },
                    {
                        block: '۹۰ دقیقه',
                        title: 'عدم‌قطعیت حیاتی',
                        desc: 'دو محور و چهار منطق.'
                    },
                    {
                        block: '۹۰ دقیقه',
                        title: 'روایت‌ها',
                        desc: 'نام و داستان هر ربع.'
                    },
                    {
                        block: '۶۰ دقیقه',
                        title: 'indicators و اقدام',
                        desc: 'نشانه‌ها و no-regret.'
                    }
                ],
                stakeholders: [
                    {
                        role: 'مدیرعامل/اسپانسر',
                        job: 'پرسش تصمیم'
                    },
                    {
                        role: 'استراتژی',
                    ...
                    {
                        role: 'مالی',
                        job: 'پیامد سرمایه‌گذاری'
                    },
                    {
                        role: 'محصول',
                        job: 'indicators بازار'
                    }
                ],
                deliverables: [
                    'پرسش تصمیم مکتوب',
                    'ماتریس ۲×۲',
                    'چهار روایت کوتاه',
                    'تابلوی indicators و اقدامات no-regret'
                ],
                workflow: [
                    {
                        title: 'تصمیم',
                        desc: 'پرسش را قفل کنید.'
                    },
                    {
                        title: 'محور',
                        desc: 'دو عدم‌قطعیت حیاتی.'
                    },
                    {
                        title: 'روایت',
                        desc: 'منطق هر سناریو.'
                    ...
                    {
                        title: 'پایش',
                        desc: 'indicators و گزینه‌های مقاوم.'
                    }
                ],
                checklist: [
                    'سناریو پیش‌بینی نیست',
                    'محورها واقعاً عدم‌قطعیت‌اند',
                    'روایت‌ها تصمیم را لمس می‌کنند',
                    'indicators قابل‌مشاهده‌اند',
                    'اقدام no-regret تعریف شده'
                ],
                boardMemo: [
                    'پرسش تصمیم',
                    'دو محور',
                ...
                facilitator: [
                    'از روند به‌جای عدم‌قطعیت پرهیز کنید',
                    'نام‌گذاری روایت را جدی بگیرید',
                    'indicators را مبهم نگذارید',
                    'خروجی را به بودجه فصل وصل کنید'
                ]
            }
        }
    }
