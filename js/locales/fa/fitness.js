...
registerLocale('fa', {
    fitnessPage: {
        ...
        hero: {
            ...
            subtitle: 'چگونه سازمان‌ها از «آمادگی ایستای آینده» به «تناسب پویای آینده» می‌رسند تا بازارهای فردا را شکل دهند. برای هیئت‌مدیره: آیا سازمان می‌بیند، کاوش می‌کند و آزمایش می‌کند یا فقط گزارش می‌سازد؟ · بر پایه زیمنس، دویچه تلکام و معیار صنایع پرتلاطم.'
        },
        ...
        university: {
            ...
            intro: 'این مسیر یک <strong>درس کامل ۱۴ هفته‌ای</strong> است، نه یک جلسه ۹۰ دقیقه‌ای. روهربک بیش از یک دهه در زیمنس، دویچه تلکوم، بوش و ده‌ها شرکت چندملیتی مطالعه میدانی کرده؛ کتاب اشپرینگر، حدود ۳۰۰ صفحه، و رساله دانشگاه آرهوس پایه برنامه درسی است.',
            courseMeta: [
            ...
            modules: [
                { num: 'M1', id: 'm1', pickerLabel: 'مبانی', title: 'مبانی · آمادگی در برابر FITness', hours: '۳ ساعت', focus: 'چرا آینده‌نگاری سازمانی شکست می‌خورد · Zoom در برابر Nokia', readings: 'Rohrbeck (2010) فصل 1-2', activity: 'بحث گروهی + کارگاه #assessment', example: 'رادار فناوری Deutsche Telekom', visual: 'assets/fitness/modules/m1-foundations.svg', visualCaption: 'مسیر گذار از آمادگی ایستا (آمادگی) به چرخه پویای FITness · F→I→T', keyPoints: ['آینده‌نگاری سازمانی ≠ گزارش مشاور · باید به آزمون و دروازه وصل شود', 'معیار مرجع روهربک: ۳۳٪ سودآوری و ۲۰۰٪ رشد ارزش بازار برای سازمان‌های هوشیار', 'آینده‌نگاری تعبیه‌شده در خط مقدم در برابر واحد جدا؛ بحث ساختاری', 'نقشه فصل‌های ۱-۱۲ کتاب به ۷ ماژول این درس'], caseSpotlight: { title: 'Zoom در برابر Nokia', body: 'Zoom آمادگی داشت (زیرساخت دورکاری) اما FITness یعنی آزمون مداوم · Nokia آینده‌نگاری داشت اما آزمون و تحول ضعیف؛ همین تمایز M1 است.' }, deliverable: 'شروع #assessment · انتخاب سازمان پروژه · بازبینی یک پاراگراف: آمادگی یا FITness؟', sessions: [
                    ...
                    { step: '۲', time: '۴۵ دقیقه', title: 'آمادگی در برابر FITness', desc: 'نمودار مفهومی آینده‌نگاری · جدول مقایسه · Zoom/Netflix/Nokia' },
                ...
                { num: 'M2', id: 'm2', pickerLabel: 'مدل بلوغ', title: 'مدل بلوغ · پنج بعد', hours: '۳ ساعت', focus: 'پنج بعد بلوغ · از اطلاعات تا فرهنگ · سطوح ۱-۵', readings: 'Rohrbeck (2010) فصل 3-5 · Schwarz (2013)', activity: 'امتیازدهی یک سازمان واقعی · تشخیص ضعیف‌ترین بعد', example: 'خط آینده‌نگاری-به‌نوآوری زیمنس', visual: 'assets/fitness/modules/m2-maturity.svg', visualCaption: 'پنج بعد بلوغ · سطوح ۱ تا ۵ · اعتبارسنجی Schwarz (2013)', keyPoints: ['اطلاعات: پهنای باند رصد · روش‌ها: سناریو، دلفی، رادار', 'افراد: سواد آینده در خط مقدم · سازمان: دروازه بودجه و سرمایه‌گذاری', 'فرهنگ: توقف پیلوت · جایگزینی عمدی · مخالف مجاز', 'نمودار رادار باید به تشخیص واقعی برسد، نه فقط یک فرم خوش‌رنگ'], caseSpotlight: { title: 'زیمنس آینده‌نگاری سازمانی', body: 'زیمنس آینده‌نگاری را به خط لوله نوآوری وصل کرد؛ شکاف معمول در روش‌ها و سازمان است نه «نداشتن گزارش».' }, deliverable: 'ممیزی بلوغ: یک رادار + یک یادداشت کوتاه مبتنی بر شواهد درباره ضعیف‌ترین بعد', sessions: [
                ...
                { num: 'M4', id: 'm4', pickerLabel: 'کاوش', title: 'کاوش · سناریو و دروازه', hours: '۳ ساعت', focus: 'سه کارکرد آغازگر، راهبردساز، مخالف · سبد افق ۱/۲/۳', readings: 'Rohrbeck (2010) فصل 7-8 · (2014)', activity: 'کارگاه سناریو + دروازه بودجه', example: 'Nvidia CUDA · پخش آنلاین Netflix', visual: 'assets/fitness/modules/m4-prospecting.svg', visualCaption: 'سه افق ۱/۲/۳ · سه کارکرد آغازگر · راهبردساز · مخالف', keyPoints: ['آغازگر: صورت‌بندی مسئله · راهبردساز: منطق سبد و دروازه', 'مخالف: آزمون مفروضات راحت پیش از سرمایه‌گذاری', 'سناریو تهاجمی/تدافعی · قابلیت‌های پویا و ترجمه به تصمیم', 'آماده‌سازی میان‌ترم: بلوغ + کهن‌الگو · ۲۰۰۰ کلمه'], caseSpotlight: { title: 'Nvidia CUDA · Netflix پخش آنلاین', body: 'CUDA به‌عنوان اختیار راهبردی، پخش آنلاین به‌عنوان تهدید خودخواسته، هر دو وقتی معنا پیدا می‌کنند که دروازه واقعی داشته باشند.' }, deliverable: 'دو سناریو · یک دروازه بودجه · نقش مخالف در بازبینی', sessions: [
                ...
                { num: 'M5', id: 'm5', pickerLabel: 'آزمایش', title: 'آزمایش · آزمون ۹۰ روزه', hours: '۳ ساعت', focus: 'آزمون محدود · معیار توقف · دروازه تصمیم', readings: 'Rohrbeck (2010) فصل 9', activity: 'یادداشت دروازه یک‌صفحه‌ای', example: 'Blockbuster در برابر Netflix', visual: 'assets/fitness/modules/m5-probing.svg', visualCaption: 'چرخه آزمون ۹۰ روزه · شاخص عملکرد · دروازه · معیار توقف', keyPoints: ['آزمون باید کوچک، سریع و سنجش‌پذیر باشد، نه پیلوت بی‌پایان', 'سرمایه‌گذاری شرکتی باید به یادگیری و تصمیم وصل باشد، نه ژست نوآوری', 'نقش مخالف باید بتواند توقف یا بازطراحی را مطالبه کند', 'یادداشت دروازه، منطق تصمیم را در یک صفحه فشرده می‌کند'], caseSpotlight: { title: 'Blockbuster در برابر Netflix', body: 'Blockbuster آزمون را دیر و بی‌دندان پیش برد، Netflix آزمون را علیه مدل موفق خودش به کار گرفت؛ همین تفاوت، هسته M5 است.' }, deliverable: 'یادداشت دروازه یک‌صفحه: فرضیه · شاخص عملکرد · توقف · مسیر گسترش', sessions: [
            ...
            bibliography: [
                { category: 'کتاب اصلی (اجباری)', items: ['Rohrbeck (2010). <em>Corporate Foresight: Towards a Maturity Model</em>. اشپرینگر، حدود ۳۰۰ صفحه.', 'Rohrbeck (2008). رساله دکتری، دانشگاه آرهوس'] },
            ...
            examRubric: [
                ...
                { component: '#assessment', weight: '۵٪ امتیاز اضافه', desc: 'خودارزیابی + بازتاب تحلیلی' }
            ],
            discussionTitle: 'سؤالات بحث',
            discussionPrompts: ['آینده‌نگاری واحد جدا یا تعبیه‌شده؟', 'ضعیف‌ترین بعد بلوغ کدام است؟', 'کدام نشانه ضعیف نادیده گرفته می‌شود؟', 'نقش مخالف واقعاً مجاز است؟', 'کجا سازمان عصبی می‌شود؟', 'IT2 واقعاً لازم است یا افراطی است؟'],
            teachingNotesTitle: 'یادداشت استاد',
            teachingNotes: ['M1 با #assessment آغاز می‌شود · M7 برای بازنگری نهایی است', 'در مسیر MBA، M2 و M3 فشرده می‌شوند · M5 می‌تواند تکلیف خانگی باشد', 'حدود ۲۵ صفحه کتاب در هر هفته', 'تب صنعت به‌عنوان مطالعه موازی استفاده شود', 'پیوند CLA و چرخ آینده در M7 باز می‌شود']
        },
        labelRole: 'نقش',
        labelFunction: 'کارکرد در فرایند',
        labelSetup: 'زمینه',
        ...
        industry: {
            tag: 'صنعت و سازمان',
            title: 'کارگاه استقرار FITness · از تشخیص تا آزمون ۹۰ روزه',
            ...
            meta: [
                { label: 'مدت', value: '۱ روز حضوری + ۶ هفته پیگیری' },
                { label: 'صنایع', value: 'فناوری اطلاعات و ارتباطات · خودرو · دارو · انرژی · هلدینگ' },
                { label: 'مرجع میدانی', value: 'Siemens · Deutsche Telekom · Rohrbeck (2010)' },
                { label: 'ابزار این صفحه', value: '#assessment · رادار فناوری · پل IT2 فازی' }
            ],
            agendaTitle: 'برنامه یک‌روزه در شرکت',
            agenda: [
                { block: '۰۹:۰۰', title: 'تشخیص · کهن‌الگوی فعلی', desc: 'خودارزیابی ۵ بعدی، نمودار رادار، قرار دادن سازمان در ماتریس تلاطم و بلوغ · بحث: هوشیار یا آسیب‌پذیر؟' },
                ...
                { block: '۱۵:۰۰', title: 'طراحی آزمایش · ۹۰ روز', desc: 'یک پیلوت با معیار توقف، مسئول مشخص، شاخص عملکرد · الگوی حلقه آزمایش در رادار فناوری دویچه تلکوم.' },
            ...
            stakeholders: [
                ...
                { role: 'فناوری / پژوهش و توسعه', job: 'رادار فناوری، امکان‌پذیری، نقشه‌راه' },
                { role: 'واحد کسب‌وکار مسئول', job: 'تأمین داده میدانی، اجرای آزمون در خط' },
                { role: 'مالی / سبد', job: 'دروازه سرمایه‌گذاری، افق بودجه، بازده آزمون' }
            ],
            workflowTitle: '۶ گام استقرار در سازمان',
            workflowSteps: [
            ...
            caseStudies: [
                {
                    ...
                    action: 'حلقه آزمایش برای هوش مصنوعی عامل‌محور · پذیرش برای رایانش لبه‌ای · رصد برای 6G',
                    takeaway: 'رادار بدون حلقه آزمایش فقط سازمان عصبی می‌سازد · دویچه تلکوم هر فناوری را در مسیر رصد تا پذیرش نگه می‌دارد.'
                },
                {
                    title: 'زیمنس · بلوغ آینده‌نگاری سازمانی',
                    setup: 'صنعت سنگین + همزاد دیجیتال + گذار انرژی',
                    signal: 'برق سبز، اتوماسیون، کارخانه نرم‌افزارمحور',
                    action: 'سرمایه‌گذاری و آزمون در افق ۲، پیش از گسترش در افق ۱',
                    takeaway: 'FITness یعنی سبد سه‌افقی · آینده‌نگاری باید به دروازه پژوهش و توسعه وصل باشد، نه به گزارش سالانه.'
                },
                {
                    title: 'خودرو و جابه‌جایی هوشمند · گذار EV و نرم‌افزارمحور',
                    setup: 'تلاطم بالا · ورود رقبای تازه از دل فناوری',
                    signal: 'شیمی باتری، OTA، پشته خودران',
                    action: 'آزمون با سکوی مشترک · نقش مخالف برای به‌چالش‌کشیدن درآمد موتورهای درون‌سوز',
                    takeaway: 'بدون مخالف، سازمان حتی با رادار قوی هم آسیب‌پذیر می‌ماند · مثل تأخیر خودروسازان سنتی در به‌روزرسانی برخط.'
                }
            ],
            probingTitle: 'راهنمای استقرار آزمون ۹۰ روزه',
            probingPlaybook: [
                'هفته ۱-۲: تعریف فرضیه · «اگر X رخ دهد، Y٪ هزینه/درآمد تحت تأثیر است» · مسئول از واحد کسب‌وکار.',
            ...
            checklistTitle: 'چک‌لیست پیش از استقرار',
            checklistItems: [
                'آیا ۵ بعد بلوغ دست‌کم یک‌بار در ۱۲ ماه گذشته سنجیده شده‌اند؟',
            ...
            boardMemoFields: [
                ...
                'درخواست تصمیم: تأیید آزمون / تعویق / توقف'
            ]
        },
        fuzzyBridge: {
            ...
            mappingRows: [
                ...
                { fitness: 'حلقه‌های رادار فناوری', it2: 'رصد/ارزیابی/آزمایش/پذیرش با برچسب فازی، نه دوحالتی' }
            ],
            examples: [
                {
                    title: 'هوش مصنوعی مولد در مرکز تماس',
                    text: 'واحد عملیات: ارتباط 0.7-0.9 · حقوقی: 0.3-0.5 · FOU پهن → حلقه آزمایش نه پذیرش · آزمون محدود با معیار توقف انطباق.'
                },
                {
                    title: 'بازگردانی تولید در هلدینگ صنعتی',
                    text: 'راهبرد: 0.5-0.8 · زنجیره تأمین: 0.2-0.4 · گستره متوسط → آزمون ۹۰ روزه روی یک قلم محصول پیش از سرمایه‌گذاری.'
                }
            ],
        ...
        readiness: {
            ...
            p2: 'صنایع با چرخش تکنولوژیک سریع · از هوش مصنوعی مولد تا گذار انرژی · سازمان‌هایی که آمادگی را جدی گرفته‌اند، مثل پیلوت دورکاری پیش از کرونا یا رایانش لبه‌ای در مخابرات، سریع‌تر گسترش کرده‌اند؛ اما آمادگی بدون FITness به گزارش‌های انباشته تبدیل می‌شود.',
            ...
            apps: [
                { label: 'مخابرات و فناوری اطلاعات و ارتباطات', text: 'دویچه تلکام و اپراتورهای مشابه با رادار فناوری و اینترنت اشیا کشاورزی · آینده‌نگاری به حلقه آزمایش و پذیرش وصل می‌شود، نه فقط به گزارش روند.' },
                { label: 'خودرو و جابه‌جایی هوشمند', text: 'خودروسازان با آزمون به‌روزرسانی برخط و خودرو برقی پیش از گسترش · سازمان‌هایی که فقط آمادگی داشتند، در گذار به نرم‌افزارمحوری عقب ماندند.' },
                { label: 'دارو و زیست‌فناوری', text: 'رصد کشف دارو با هوش مصنوعی و رگولاتوری · پیلوت محدود پیش از سرمایه‌گذاری در خط تولید.' },
                { label: 'انرژی و صنعت سنگین', text: 'زیمنس و شرکت‌های مشابه با همزاد دیجیتال و برق سبز · سبد سه‌افقی افق ۱/۲/۳.' }
            ]
        },
        readinessCards: [
        ...
        rohrbeckDims: {
            ...
            dims: [
                ...
                { level: '۳. افراد', title: 'سرمایه انسانی و خبرگان (افراد)', desc: 'شایستگی، سواد آینده، شبکه خبره · ارتقای مهارت خط مقدم و آینده‌نگاری، نه فقط یک واحد کوچک.' },
        ...
        assessment: {
            ...
            sliders: {
                ...
                culture: { label: '۵. فرهنگ سازمانی (فرهنگ)', desc: 'پذیرش تغییر، توقف کردن پیلوت، جایگزینی عمدی · حمایت ساختار دروازه، نه فقط شعار.' }
            },
            ...
            scores: {
                fit: {
                    status: 'سرآمد و متناسب با آینده',
        ...
        foresightCards: [
            { icon: 'gauge', title: 'شاخص تطبیق سریع', desc: 'سرعت و اثربخشی واکنش در تغییر سبد محصولات.', color: 'var(--color-f)' },
            ...
            { icon: 'shield', title: 'انعطاف‌پذیری سازمانی', desc: 'شاخص تاب‌آوری: توانایی بازیابی فوری پس از اختلالات و بحران‌های مالی و زیست‌محیطی.', color: 'var(--color-f)' },
            { icon: 'users', title: 'تعامل در اکوسیستم', desc: 'شاخص همکاری: میزان ارزش‌آفرینی مشترک با شرکا و ذی‌نفعان زنجیره تأمین.', color: 'var(--color-f)' },
            { icon: 'book-open', title: 'یادگیری سازمانی', desc: 'شاخص یادگیری و توسعه: میزان آموزش تخصصی و ارتقای مهارت نیروی کار در سال.', color: 'var(--color-f)' }
        ],
        radar: {
            ...
            dtChallengesBody: '<strong>مقاومت در برابر تغییر:</strong> تقویت فرهنگ باز و پذیرش تغییر.<br><strong>شکاف مهارتی کارکنان:</strong> برگزاری مداوم دوره‌های بازآموزی.<br><strong>پیچیدگی اکوسیستم باز:</strong> به‌کارگیری فناوری‌های باز و شفاف.<br><strong>تعارض اهداف کوتاه‌مدت و بلندمدت:</strong> تخصیص بودجه مجزا و مدل سه افق نوآوری.',
            ...
            bioQuadrantNote: 'دویچه تلکام در بیوتک آزمایشگاهی، یعنی داروسازی و مهندسی ژنتیک، فعالیت نمی‌کند. ربع پایین‑راست نشان‌دهنده بازار مجاور سلامت دیجیتال است: پزشکی از راه دور، اینترنت اشیا سلامت و پلتفرم‌های مراقبت از راه دور روی شبکه دویچه تلکوم و T-Systems؛ همان منطق «رصد افق‌های مجاور» در مطالعه Rohrbeck و همکاران (2007).',
            ...
            tech: {
                ...
                '6g': { title: 'نسل ششم ارتباطات موبایل (6G)', quadrant: 'شبکه‌های ارتباطی', status: 'رصد', desc: 'سرعت‌های ترابیت بر ثانیه، تاخیرهای میکروثانیه‌ای و ادغام شبکه‌های زمینی با ماهواره‌ها برای پوشش صد درصدی.', impact: 'بسترسازی اینترنت حواس، ربات‌های همکار دوردست و ارتباطات هولوگرافیک سه‌بعدی.' },
                ...
                telehealth: { title: 'پزشکی از راه دور و مراقبت غیرحضوری', quadrant: 'سلامت دیجیتال و مراقبت از راه دور', status: 'آزمایش', desc: 'پلتفرم‌های ویزیت آنلاین، پرونده الکترونیک و اتصال بیمار و پزشک روی زیرساخت مخابراتی دویچه تلکوم و T-Systems Healthcare؛ بازار مجاور، نه بیوتک آزمایشگاهی.', impact: 'درآمد B2B2C در بخش سلامت · کاهش فشار بر شبکه با رایانش لبه‌ای و کیفیت خدمات اختصاصی.' },
                healthIoT: { title: 'اینترنت اشیا سلامت و پایش از راه دور', quadrant: 'سلامت دیجیتال و مراقبت از راه دور', status: 'ارزیابی', desc: 'حسگرهای پوشیدنی و دستگاه‌های پایش بیمار در منزل که از طریق شبکه NB-IoT و LTE-M به مرکز تماس متصل می‌شوند.', impact: 'مدل اشتراک برای اپراتور · هم‌افزایی با اینترنت اشیا کشاورزی در M3 روی همان پشته شبکه.' }
            }
        },
        common: {
