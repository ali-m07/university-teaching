    ...
    lessons: {
        ...
        hines: {
            ...
            objectives: [
                ...
                'شش جزء چارچوب‌بندی، چهار جزء پویش و پنج جزء پیش‌بینی را جدا نام ببرید.',
                'برای یک مسئله سازمانی بگویید در کدام ستون و کدام جزء گیر کرده‌اید.',
            ...
            outline: [
                ...
                { step: '۲', time: '۳۵ دقیقه', title: 'چارچوب‌بندی و پویش', desc: 'اجزای ستون ۱ و ۲، جزءبه‌جزء.' },
                { step: '۳', time: '۳۵ دقیقه', title: 'پیش‌بینی و بدیل‌ها', desc: 'پیشران، واگرایی، همگرایی، بدیل‌ها و مخروط.' },
                { step: '۴', time: '۲۰ دقیقه', title: 'برنامه‌ریزی تا اقدام', desc: 'نقشه راه و پایلوت؛ جایی آینده‌نگاری می‌میرد.' },
                { step: '۵', time: '۱۵ دقیقه', title: 'بازتاب', desc: 'نقشه ستون‌ها و اجزای سازمان خود را بکشید.' }
            ],
            readings: [
            ...
            assignment: 'مسئله آینده‌نگاری سازمان خود را در ستون چارچوب‌بندی جزءبه‌جزء بنویسید (۱ صفحه). ضعیف‌ترین جزء و یک خروجی برای پویش یا پیش‌بینی را مشخص کنید.'
        },
        scenarios: {
            meta: {
                module: '۷',
