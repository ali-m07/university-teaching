...
registerLocale('fa', {
    ...
    lessons: {
        ...
        hines: {
            ...
            objectives: [
                'شش ستون چارچوب‌بندی تا اقدام را به ترتیب توضیح دهید.',
                'هر ستون را به‌عنوان یک ارائه باز کنید و بخش‌های اسلاید داخل چارچوب‌بندی، پویش، پیش‌بینی، چشم‌اندازسازی، برنامه‌ریزی و اقدام را نام ببرید.',
                'هر ستون را به گام Framework Foresight (۷.۱ تا ۷.۶) نگاشت کنید.',
                'مخروط محتمل‌بودن را بکشید و به چشم‌اندازسازی وصل کنید.'
            ],
            outline: [
                { step: '۱', time: '۱۵ دقیقه', title: 'از جعبه ابزار به مسیر', desc: 'چرا مدیران FRM را سنگین می‌بینند.' },
                { step: '۲', time: '۳۰ دقیقه', title: 'ارائه چارچوب‌بندی و پویش', desc: 'هر ستون یک کارت؛ اجزا با ورق زدن اسلاید.' },
                { step: '۳', time: '۳۰ دقیقه', title: 'پیش‌بینی و چشم‌اندازسازی', desc: 'بدیل‌ها، مخروط، آینده مطلوب.' },
                { step: '۴', time: '۲۵ دقیقه', title: 'برنامه‌ریزی، اقدام، Framework Foresight', desc: 'گزینه‌ها، دستورکار اقدام، جریان روش هیوستون.' },
                { step: '۵', time: '۲۰ دقیقه', title: 'بازتاب', desc: 'نقشه ستون‌ها و حلقه ضعیف سازمان خود را بکشید.' }
            ],
            readings: [
                { type: 'کتاب', text: 'Hines, A. & Bishop, P. (2006). <em>Thinking About the Future</em>. ویرایش‌های ۲۰۱۳ تا ۲۰۲۰.' },
                { type: 'مقاله', text: 'Hines, A. & Bishop, P. (2013). Framework foresight: Exploring futures the Houston way. <em>Futures</em>, 51, صفحات 31 تا 49.' }
            ],
            assignment: 'مسئله آینده‌نگاری سازمان خود را روی شش ستون بنویسید (۱ صفحه). ضعیف‌ترین ستون و یک گام بعدی Framework Foresight را مشخص کنید.'
        },
        scenarios: {
            meta: {
                module: '۷',
